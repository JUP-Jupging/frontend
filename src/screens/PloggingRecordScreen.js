...
          <Image 
            source={{ 
              uri: recordData?.mapImage || recordData?.routeImage || 
                   "https://via.placeholder.com/400x250/4CAF50/FFFFFF?text=Plogging+Route" 
            }}
...
            <Text style={styles.overlayTitle}>플로깅 완료!</Text>
            <Text style={styles.overlaySubtitle}>경로가 성공적으로 기록되었습니다</Text>
          </View>
        </View>
...
              <Text style={styles.sectionSubtitle}>이동한 경로가 기록되었습니다</Text>
            </View>
            
...
                  <Text style={styles.routeStatText}>총 거리: {recordData.distance}</Text>
                </View>
                <View style={styles.routeStatItem}>
                  <Icon name="access-time" size={20} color="#4CAF50" />
                  <Text style={styles.routeStatText}>소요 시간: {recordData.duration}</Text>
                </View>
              </View>
            </View>
          </View>
...
  },
  sectionHeader: {
    // 🎨 변경: 가로 정렬 및 세로 중앙 정렬을 위한 스타일 추가
    flexDirection: "row",
    alignItems: "center",
    gap: screenWidth * 0.02,
